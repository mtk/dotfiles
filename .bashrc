...
alias j=jobs
alias k=kill
alias m=mill                    # from 'make' (C/C++) to 'mill' (scala!)
alias ma=man
alias n=nmcli
alias p=perl
alias pa=path
...
alias ns='netstat -p'
alias nsk='kill $(fps gkrellm | g -v UID | field 1)'
...
alias pc='perl -cw'
alias pf='perldoc -f'
alias pipeshow='systemctl --user status pipewire{,-pulse} wireplumber;echo "------- pactl info";pactl info'
alias pipestart='systemctl --user daemon-reload; systemctl --user restart pipewire{,-pulse}.socket'
alias plj='path $(latest-jars)'
alias psc='ps xawf -eo pid,user,cgroup,args'
alias pst='pstree -C age -l -n -S -t -a'
